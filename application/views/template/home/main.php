        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-8 text-center text-lg-start">
              <h1 data-aos="fade-right">Opt for Profit-Oriented Investment Plans</h1>
              <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Discover an array of investment plans meticulously crafted to align with your aspirations. Embrace the opportunity to invest wisely and reap the rewards of strategic financial decisions. Your journey to prosperity begins here.</p>
              <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a href="#" class="btn btn-outline-white">Get started</a></p>
            </div>
            <div class="col-lg-4 iphone-wrap">
              <img src="assets/home/img/phone_1.png" alt="Image" class="phone-1" data-aos="fade-right">
              <img src="assets/home/img/phone_22.png" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="200">
            </div>
          </div>
        </div>
      </div>
